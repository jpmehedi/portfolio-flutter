...
class PortfolioMobilePage extends StatefulWidget {
  @override
  _PortfolioMobilePageState createState() => _PortfolioMobilePageState();
}

class _PortfolioMobilePageState extends State<PortfolioMobilePage> {
